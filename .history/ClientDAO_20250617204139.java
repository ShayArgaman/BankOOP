...
public class ClientDAO {
     ...
     * This is the actual implementation that works with the database.
     */
    private static Client addClient(Connection conn, Client newClient) throws SQLException {
     ...
     * This is the actual implementation that works with the database.
     */
    private static boolean clientExists(Connection conn, int clientId) throws SQLException {
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        try {
     ...
     */
    private static boolean isClientAssociatedWithAnyAccount(Connection conn, int clientId) throws SQLException {
        PreparedStatement pstmt = null;
        ResultSet rs = null;
     ...
     */
    private static boolean deleteClientById(Connection conn, int clientId) throws SQLException {
        PreparedStatement pstmt = null;
        boolean success = false;
